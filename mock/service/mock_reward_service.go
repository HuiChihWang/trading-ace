...
// GetRewardHistory provides a mock function with given fields: userID
func (_m *MockRewardService) GetRewardHistory(userID string) ([]*model.RewardRecord, error) {
...
//   - userID string
func (_e *MockRewardService_Expecter) GetRewardHistory(userID interface{}) *MockRewardService_GetRewardHistory_Call {
	return &MockRewardService_GetRewardHistory_Call{Call: _e.mock.On("GetRewardHistory", userID)}
}

func (_c *MockRewardService_GetRewardHistory_Call) Run(run func(userID string)) *MockRewardService_GetRewardHistory_Call {
...
func (_c *MockRewardService_GetRewardHistory_Call) RunAndReturn(run func(string) ([]*model.RewardRecord, error)) *MockRewardService_GetRewardHistory_Call {
	_c.Call.Return(run)
	return _c
}
